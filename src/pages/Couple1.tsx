    ...
    <div className="min-h-screen bg-background overflow-auto">
      ...
      <section className="pt-24 pb-16 bg-gradient-to-b from-cream-50 to-white">
        <div className="max-w-6xl mx-auto px-6 text-center">
          ...
          >
            Aniket & Debosmita
            <span className="block text-blush-500 italic">Wedding Gallery</span>
          </FadeInText>
          <FadeInText
            as="p"
            ...
            delay={0.3}
          >
            A beautiful celebration of love captured through our lens. Every
            moment, every emotion, preserved forever.
          </FadeInText>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[200px]">
            {filteredPhotos.map((photo, index) => (
              <motion.div
                key={photo.id}
                className={`group relative overflow-hidden rounded-2xl ${getGridClass(
                  photo.size
                )}`}
