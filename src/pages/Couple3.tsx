...
const Couple3 = () => {
  ...
  const coupleInfo = {
    ...
    venue: "Backwater Paradise Resort, Kerala",
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <Link
              to="/"
              className="inline-flex items-center gap-2 text-green-600 hover:text-green-700 transition-colors mb-8 group"
            >
            ...
            <div className="flex items-center justify-center gap-3 mb-6">
              ...
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-green-600 via-emerald-600 to-teal-600 bg-clip-text text-transparent">
                {coupleInfo.names}
              </h1>
              <Heart className="w-8 h-8 text-green-500" />
            </div>
          ...
          >
            <div className="text-center p-6 bg-white/70 backdrop-blur-sm rounded-2xl shadow-lg border border-green-100">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Nature's <span className="text-green-600">Embrace</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              A perfect harmony of love and nature, captured in Kerala's most beautiful backwater setting
            </p>
          </div>
      ...
      <section className="py-24 bg-gradient-to-br from-gray-50 to-green-50">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-6">
              Serene <span className="text-green-600">Moments</span>
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Experience the tranquil beauty of their backwater wedding through our cinematic storytelling
            </p>
          </div>

          <div className="relative">
            <div className="aspect-video bg-gradient-to-br from-green-100 to-emerald-100 rounded-3xl overflow-hidden shadow-2xl">
              <div className="w-full h-full flex items-center justify-center">
                <div className="text-center">
                  <div className="w-20 h-20 bg-green-500 rounded-full flex items-center justify-center mb-4 mx-auto hover:bg-green-600 transition-colors cursor-pointer">
                    <Play className="w-8 h-8 text-white ml-1" />
                  </div>
                  <p className="text-gray-600 font-medium">Backwater Wedding Film</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Create Your Natural
              <br />
              <span className="text-green-100">Love Story</span>
            </h2>
            <p className="text-xl text-green-100 mb-10 max-w-2xl mx-auto">
              Let nature be the backdrop for your perfect wedding day. We capture the organic beauty of your celebration.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="bg-white text-green-600 px-8 py-4 rounded-full font-semibold hover:bg-green-50 transition-all duration-300 shadow-lg hover:shadow-xl hover:-translate-y-1"
              >
                Book Your Session
              </Link>
              <Link
